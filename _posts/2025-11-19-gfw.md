---
layout:     post
title:      "Bypassing the Great Firewall: A History and Analysis of Proxy Protocols"
date:       2025-11-19 23:00:00 +0800
categories: Network
tags:       gfw vpn proxy
summary:    "The Great Firewall (GFW) serves as China's internet censorship system, restricting access to certain foreign websites and services. To circumvent these restrictions, users often employ various proxy protocols. This article introduces several common proxy protocols and their working principles."
---
...
Trojan was developed and open-sourced by the {% github_link https://github.com/trojan-gfw/trojan name="TrojanGfw" %} project in 2019, aiming to provide a simple and effective proxy solution. Unlike VMess's pursuit of comprehensive features, Trojan focuses on simplified design, disguising proxy traffic as normal HTTPS traffic to evade GFW detection.
